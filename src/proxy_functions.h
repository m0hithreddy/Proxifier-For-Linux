...
#define PROXY_MODE_DELIMIT 0b0001
#define PROXY_MODE_PERMIT 0b0000
#define PROXY_MODE_NULL_RESULT 0b0010
#define PROXY_MODE_SCOPY_SSEEK_DELIMIT 0b0100
#define PROXY_MODE_SCOPY_SSEEK_PERMIT 0b1000
